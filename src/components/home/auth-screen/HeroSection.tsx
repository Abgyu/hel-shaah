            ...
            pointer-events-none select-none'
				...
				<div className='flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold'>
					...
					<p className='text-2xl md:text-3xl text-balance'>
						soodhawaad <span className='bg-stone-800 px-2 font-bold text-white'>wamaxay ganacsigaaga</span>markale soodhawoow meshaan waa meel ku farxad galindoonta
						kahel.
					</p>
					<p className='text-2xl md:text-3xl mb-32 leading-snug text-balance'>
						soogali waxsoosaarkaaga, sidoo kale iibso <span className='bg-sky-500 font-bold px-2 text-white'>ganacsi xiiso leh</span> maxaa{" "}
						<span className='bg-red-500 px-2 font-bold text-white'> ku cajab galiya macmiil?</span>
					</p>
					<AuthButtons />
				</div>
			</div>
